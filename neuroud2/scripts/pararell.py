...
class Worker(mp.Process):
    ...
    def run(self):
        ...
        def currentState(msg):
            ...
            x = msg.pose[msg.name.index('ubiquitous_display')].position.x
            y = msg.pose[msg.name.index('ubiquitous_display')].position.y
            x_vel = msg.twist[msg.name.index('ubiquitous_display')].linear.x
            y_vel = msg.twist[msg.name.index('ubiquitous_display')].linear.y
            rot_q = msg.pose[msg.name.index('ubiquitous_display')].orientation
